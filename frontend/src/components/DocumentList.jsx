          ...
          {documents.map((doc, index) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-lg transition-all card-hover"
              >
                ...
                {doc.status === 'completed' && (
                  <button
                    onClick={() => navigate('/dashboard?tab=query&doc=' + doc.id)}
                    className="mt-4 w-full flex items-center justify-center space-x-2 px-4 py-2 bg-primary-50 text-primary-700 rounded-lg hover:bg-primary-100 transition-colors"
                  >
