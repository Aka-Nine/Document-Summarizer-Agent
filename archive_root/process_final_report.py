#!/usr/bin/env python3
"""Process final_report.pdf - saves to report_results.txt"""
import sys
import os
import asyncio
...
async def process():
    ...
    with open(output_file, "w", encoding="utf-8") as f:
        ...
        try:
            ...
            documents = processor.load_document(str(pdf))
            f.write(f"Loaded {len(documents)} pages\n\n")
            f.flush()
            
            f.write("Processing with AI (this may take 1-2 minutes)...\n")
            f.flush()
