...
- [GEMINI_FILESYSTEM_SETUP.md](GEMINI_FILESYSTEM_SETUP.md) - Gemini & filesystem setup
- [NO_DOCKER_SETUP.md](NO_DOCKER_SETUP.md) - Running without Docker
...
**Note**: README.md remains in the project root for GitHub/GitLab visibility.
